    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-400">
                ...
                eliminados permanentemente. Antes de eliminar tu cuenta, descarga cualquier
                dato o información que desees conservar.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-400">
                    ...
                    serán eliminados permanentemente. Por favor, introduce tu contraseña para
